...
Insert into HRIS_MENUS (MENU_CODE,MENU_ID,MENU_NAME,PARENT_MENU,MENU_DESCRIPTION,ROUTE,STATUS,CREATED_DT,MODIFIED_DT,ICON_CLASS,ACTION,MENU_INDEX,CREATED_BY,MODIFIED_BY,IS_VISIBLE) values (null,361,'Payroll',6,null,'payroll','E',to_date('13-APR-18','DD-MON-RR'),null,'fa fa-square-o','javascript::',99,292,null,'Y');
Insert into HRIS_MENUS (MENU_CODE,MENU_ID,MENU_NAME,PARENT_MENU,MENU_DESCRIPTION,ROUTE,STATUS,CREATED_DT,MODIFIED_DT,ICON_CLASS,ACTION,MENU_INDEX,CREATED_BY,MODIFIED_BY,IS_VISIBLE) values (null,362,'Payslip',361,null,'payroll','E',to_date('13-APR-18','DD-MON-RR'),null,'fa fa-square-o','payslip',1,292,null,'Y');
Insert into HRIS_MENUS (MENU_CODE,MENU_ID,MENU_NAME,PARENT_MENU,MENU_DESCRIPTION,ROUTE,STATUS,CREATED_DT,MODIFIED_DT,ICON_CLASS,ACTION,MENU_INDEX,CREATED_BY,MODIFIED_BY,IS_VISIBLE) values (null,363,'Taxslip',361,null,'payroll','E',to_date('13-APR-18','DD-MON-RR'),null,'fa fa-square-o','taxslip',2,292,null,'Y');
