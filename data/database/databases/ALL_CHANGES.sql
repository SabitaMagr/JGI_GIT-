...
CREATE TABLE HRIS_ADVANCE_MASTER_SETUP(
  ...
  DEDUCTION_RATE NOT NULL NUMBER (5,2),
  DEDUCTION_IN NOT NULL NUMBER(2,0),
...
update hris_menus set route='advance-setup' where lower(menu_name)='advance' and route='advance';
...
update hris_menus set route='advance-request' where lower(MENU_NAME)='advance request';

update hris_menus set route='advance-approve' where lower(MENU_NAME)='advance to approve';

update hris_menus set route='advance-approve',action='status' where lower(menu_name)='advance status';


ALTER TABLE HRIS_MONTH_CODE
ADD NEP_YEAR NUMBER(4);

ALTER TABLE HRIS_MONTH_CODE
ADD NEP_MONTH NUMBER(2);

UPDATE HRIS_MONTH_CODE SET NEP_YEAR=2072 WHERE FISCAL_YEAR_ID=1;
UPDATE HRIS_MONTH_CODE SET NEP_YEAR=2073 WHERE FISCAL_YEAR_ID=2;
UPDATE HRIS_MONTH_CODE SET NEP_YEAR=2074 WHERE FISCAL_YEAR_ID=3;

UPDATE HRIS_MONTH_CODE SET NEP_MONTH=1 WHERE MONTH_EDESC='Baishakh';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=2 WHERE MONTH_EDESC='Jestha';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=3 WHERE MONTH_EDESC='Ashadh';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=4 WHERE MONTH_EDESC='Shrawan';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=5 WHERE MONTH_EDESC='Bhadra';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=6 WHERE MONTH_EDESC='Ashwin';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=7 WHERE MONTH_EDESC='Kartik';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=8 WHERE MONTH_EDESC='Mangsir';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=9 WHERE MONTH_EDESC='Paush';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=10 WHERE MONTH_EDESC='Magh';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=11 WHERE MONTH_EDESC='Falgun';
UPDATE HRIS_MONTH_CODE SET NEP_MONTH=12 WHERE MONTH_EDESC='Chaitra';
