...
Insert into HRIS_MENUS (MENU_CODE,MENU_ID,MENU_NAME,PARENT_MENU,MENU_DESCRIPTION,ROUTE,
STATUS,CREATED_DT,MODIFIED_DT,ICON_CLASS,ACTION,MENU_INDEX,CREATED_BY,MODIFIED_BY,IS_VISIBLE) 
values ('901',372,'Leave Report Card',2,null,'leavereportcard','E',to_date('16-APR-19','DD-MON-RR'),
null,null,'index',901,700280,null,'Y');
