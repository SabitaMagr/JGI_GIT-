...
BEGIN
  ...
  END IF;
  IF(TRUNC(P_ATTENDANCE_DT)<TRUNC(SYSDATE)) THEN
    HRIS_REATTENDANCE(TRUNC(P_ATTENDANCE_DT),P_EMPLOYEE_ID,TRUNC(P_ATTENDANCE_DT));
  END IF;
EXCEPTION
WHEN NO_DATA_FOUND THEN
  NULL;
...
BEGIN
  ...
  DELETE FROM HRIS_ATTENDANCE_PAYROLL WHERE ATTENDANCE_DT BETWEEN V_MONTH_START_DATE AND V_MONTH_END_DATE;
  FOR d IN
