...
SELECT MAX(TO_DATE(TO_CHAR(A.ATTENDANCE_DT,'DD-MON-YYYY')
  ...
  TO_DATE(TO_CHAR(P_FROM_ATTENDANCE_TIME+1,'DD-MON-YYYY')||'2:30 PM','DD-MON-YYYY HH:MI AM') 
  AND
  TO_DATE(TO_CHAR(P_FROM_ATTENDANCE_TIME+1,'DD-MON-YYYY')||'6:30 PM','DD-MON-YYYY HH:MI AM'));
