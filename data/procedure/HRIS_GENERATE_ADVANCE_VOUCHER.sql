CREATE OR REPLACE PROCEDURE HRIS_GENERATE_ADVANCE_VOUCHER(
...
END;
SELECT FN_NEW_VOUCHER_NO('01','436',TRUNC(SYSDATE),'FA_DOUBLE_VOUCHER') AS VOUCHER_NO FROM DUAL;
EXECUTE HRIS_GENERATE_ADVANCE_VOUCHER('01','436',TRUNC(SYSDATE),'01.01','ADMIN',TRUNC(SYSDATE),1002,'TEST',1000,'S1283','FCT/BPM/00084/73-74');
SELECT * FROM MASTER_TRANSACTION WHERE VOUCHER_NO ='FCT/BPM/00084/73-74';