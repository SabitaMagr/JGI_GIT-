    ...
    LOOP
      ...
      END;
        ...
        SELECT 
            ...
            ELSE 0
           END),
           (CASE WHEN V_DIFF_IN_MIN >=465 AND V_DIFF_IN_MIN IS NOT NULL AND V_NIGHT_SHIFT_FLAG='Y'
            THEN 1
            ELSE 0
           END),
           (CASE WHEN V_DIFF_IN_MIN >=465 AND V_DIFF_IN_MIN IS NOT NULL AND V_SHIFT_ALLOWANCE_FLAG='Y'
            THEN 1
            ELSE 0
           END),
           (
