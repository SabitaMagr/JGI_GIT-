...
SELECT V_TO_DATE -  V_FROM_DATE INTO V_DATE_DIFF FROM   dual;
  ...
  SELECT TO_CHAR(V_FROM_DATE+i,'D') INTO V_TEMP_DAY FROM DUAL;
   ...
   BEGIN
    ...
    INSERT INTO HRIS_CUST_CONTRACT_ATTENDANCE (CONTRACT_ID,ATTENDANCE_DT,EMPLOYEE_ID,MONTH_CODE_ID) VALUES (V_CONTRACT_ID,V_FROM_DATE+i,V_EMPLOYEES.EMPLOYEE_ID,V_MONTH_CODE_ID);
    END LOOP;
...
BEGIN
    ...
    BEGIN
    FOR V_EMPLOYEES IN (SELECT * FROM HRIS_CUST_CONTRACT_EMP WHERE CONTRACT_ID=V_CONTRACT_ID AND MONTH_CODE_ID=V_MONTH_CODE_ID) LOOP
    INSERT INTO HRIS_CUST_CONTRACT_ATTENDANCE (CONTRACT_ID,ATTENDANCE_DT,EMPLOYEE_ID,MONTH_CODE_ID) VALUES (V_CONTRACT_ID,V_R_DATES.MANUAL_DATE,V_EMPLOYEES.EMPLOYEE_ID,V_MONTH_CODE_ID);
    END LOOP;
