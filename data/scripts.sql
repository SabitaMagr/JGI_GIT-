...
(
	...
	CONSTRAINT FK_ASSET_G_COMPANY_COM_ID FOREIGN KEY(COMPANY_ID) REFERENCES HR_COMPANY(COMPANY_ID),
	CONSTRAINT FK_ASSET_G_BRANCH_BNC_ID FOREIGN KEY(BRANCH_ID) REFERENCES HR_BRANCHES(BRANCH_ID),
	CONSTRAINT FK_ASSET_G_EMPLOYEE_EMP_ID FOREIGN KEY(CREATED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
	CONSTRAINT FK_ASSET_G_EMPLOYEE_EMP_ID2 FOREIGN KEY(MODIFIED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
	CONSTRAINT FK_ASSET_G_EMPLOYEE_EMP_ID3 FOREIGN KEY(APPROVED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID)	
	
);

CREATE TABLE HR_ASSET_SETUP
(
	...
	CONSTRAINT FK_ASSET_S_GROUP_ID FOREIGN KEY (ASSET_GROUP_ID) REFERENCES HR_ASSET_GROUP(ASSET_GROUP_ID),
CONSTRAINT FK_ASSET_S_COMPANY_COM_ID FOREIGN KEY(COMPANY_ID) REFERENCES HR_COMPANY(COMPANY_ID),
	CONSTRAINT FK_ASSET_S_BRANCH_BNC_ID FOREIGN KEY(BRANCH_ID) REFERENCES HR_BRANCHES(BRANCH_ID),
	CONSTRAINT FK_ASSET_S_EMPLOYEE_EMP_ID FOREIGN KEY(CREATED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
	CONSTRAINT FK_ASSET_S_EMPLOYEE_EMP_ID2 FOREIGN KEY(MODIFIED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
	CONSTRAINT FK_ASSET_S_EMPLOYEE_EMP_ID3 FOREIGN KEY(APPROVED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID)
);


CREATE TABLE HR_ASSET_ISSUE
  (
    ...
    CONSTRAINT FK_ASSET_I_ASSET_ID FOREIGN KEY(ASSET_ID) REFERENCES HR_ASSET_SETUP(ASSET_ID),
    CONSTRAINT FK_ASSET_I_COMPANY_COM_ID FOREIGN KEY(COMPANY_ID) REFERENCES HR_COMPANY(COMPANY_ID),
    CONSTRAINT FK_ASSET_I_BRANCH_BNC_ID FOREIGN KEY(BRANCH_ID) REFERENCES HR_BRANCHES(BRANCH_ID),
    CONSTRAINT FK_ASSET_I_EMPLOYEE_EMP_ID FOREIGN KEY(CREATED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
    CONSTRAINT FK_ASSET_I_EMPLOYEE_EMP_ID2 FOREIGN KEY(MODIFIED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
    CONSTRAINT FK_ASSET_I_EMPLOYEE_EMP_ID3 FOREIGN KEY(APPROVED_BY) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID),
    CONSTRAINT FK_ASSET_I_EMPLOYEE_EMP_ID4 FOREIGN KEY(EMPLOYEE_ID) REFERENCES HR_EMPLOYEES(EMPLOYEE_ID)
  )
