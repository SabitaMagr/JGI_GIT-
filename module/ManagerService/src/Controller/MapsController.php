...
use ManagerService\Repository\MapsRepository;
use Exception;
...
class MapsController extends HrisController {
    ...
    public function indexAction() {
        ...
        $filteredEmployees = $this->repository->fetchAllEmployee($this->employeeId);
        
        foreach($searchValues['employee'] as $key => $value){
            if(!array_key_exists($searchValues['employee'][$key]['EMPLOYEE_ID'], $filteredEmployees)){
               unset($searchValues['employee'][$key]);
            }
        } 
