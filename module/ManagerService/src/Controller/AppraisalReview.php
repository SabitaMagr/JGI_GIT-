...
class AppraisalReview extends AbstractActionController{
    ...
    public function viewAction(){
        ...
        foreach($headingList as $headingRow){
            ...
            $appraiserQuestionList =$this->getAllQuestionWidOptions($headingRow['HEADING_ID'],$currentStageId,$appraiserFlag,$appraisalId,$employeeId,$assignedAppraisalDetail['APPRAISER_ID']);
            ...
            $reviewerQuestionList = $this->getAllQuestionWidOptions($headingRow['HEADING_ID'], $currentStageId, $reviewerFlag, $appraisalId,$employeeId,$this->employeeId);
