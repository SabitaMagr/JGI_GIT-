...
class Subordinate extends HrisController {
    ...
    public function editAction() {
        ...
        return $this->stickFlashMessagesTo([
                    ...
                    "genders" => ApplicationHelper::getTableKVList($this->adapter, Gender::TABLE_NAME, Gender::GENDER_ID, [Gender::GENDER_NAME], null, null, true),
                    "zones" => ApplicationHelper::getTableKVList($this->adapter, Zones::TABLE_NAME, Zones::ZONE_ID, [Zones::ZONE_NAME], null, null, true),
