...
class MedicalSettlement extends HrisController {
    ...
    public function viewAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($action == "Reject") {
                ...
                $medical->billStatus = "PD";
                $this->flashmessenger()->addMessage("Medical Bill Approved");
            }

            $medical->transferedBy = $this->employeeId;
            $medical->bankTransferDt = Helper::getcurrentExpressionDate();
