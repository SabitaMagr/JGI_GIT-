...
class LoanClosingRepository implements RepositoryInterface {
    ...
    public function delete($id) {
        $this->tableGateway->update([LoanClosingModel::STATUS => 'C'], [LoanClosingModel::LOAN_REQUEST_ID => $id]);
    }

    public function edit(Model $model, $id) {
        $this->tableGateway->update($model->getArrayCopyForDB(), [LoanClosingModel::ID => $id]);
    }
