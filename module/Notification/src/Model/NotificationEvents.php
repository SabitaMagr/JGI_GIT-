...
class NotificationEvents {
    ...
    const TRAINING_REQ_APPLIED = 49;
    const TRAINING_REQ_RECOMMEND_ACCEPTED = 50;
    const TRAINING_REQ_RECOMMEND_REJECTED = 51;
    const TRAINING_REQ_APPROVE_ACCEPTED = 52;
    const TRAINING_REQ_APPROVE_REJECTED = 53;
    const TRAINING_REQ_CANCELLED = 54;
    
    const SUBSTITUTEWORK_APPLIED = 55;
    const SUBSTITUTEWORK_ACCEPTED = 56;
    const SUBSTITUTEWORK_REJECTED = 57;
}