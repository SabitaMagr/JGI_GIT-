...
class FlatValue extends AbstractActionController
{
    ...
    public function detailAction(){
        ...
        $flatValues = EntityHelper::getTableKVList($this->adapter, FlatValueModel::TABLE_NAME, FlatValueModel::FLAT_ID, [FlatValueModel::FLAT_EDESC],null,null,null,null,false,true);
