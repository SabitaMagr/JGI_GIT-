...
SELECT A.APPRAISAL_ID                          AS APPRAISAL_ID,
  ...
  BS_DATE(TO_CHAR(A.START_DATE,'DD-MON-YYYY')) AS START_DATE_NEP,
  INITCAP(TO_CHAR(A.END_DATE,'DD-MON-YYYY'))   AS END_DATE,
  BS_DATE(TO_CHAR(A.END_DATE,'DD-MON-YYYY'))   AS END_DATE_NEP,
