...
class LeaveSubstituteRepository implements RepositoryInterface{
    ...
    public function fetchByEmployeeId($employeeId){
        ...
        $select->from(['LA' => LeaveApply::TABLE_NAME])
                ...
                ->join(['LS'=>"HRIS_LEAVE_SUBSTITUTE"],"LS.LEAVE_REQUEST_ID=LA.ID",["SUB_EMPLOYEE_ID"=>"EMPLOYEE_ID","SUB_APPROVED_DATE"=>"APPROVED_DATE","SUB_APPROVED_FLAG"=>"APPROVED_FLAG"],"left");
