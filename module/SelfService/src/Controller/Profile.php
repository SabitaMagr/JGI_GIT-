...
class Profile extends AbstractActionController {
    ...
    public function profileAction() {
        ...
        return Helper::addFlashMessagesToArray($this, [
                    ...
                    "companies" => ApplicationHelper::getTableKVList($this->adapter, "HRIS_COMPANY","COMPANY_ID",["COMPANY_NAME"],["STATUS"=>"E"],"COMPANY_ NAME","ASC",null,false,true),
                    ...
                    'serviceTypes' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_SERVICE_TYPES", "SERVICE_TYPE_ID", ["SERVICE_TYPE_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'positions' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_POSITIONS", "POSITION_ID", ["POSITION_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'designations' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_DESIGNATIONS", "DESIGNATION_ID", ["DESIGNATION_TITLE"], ["STATUS" => 'E'],null,null,null,false,true),
                    'departments' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_DEPARTMENTS", "DEPARTMENT_ID", ["DEPARTMENT_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'branches' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_BRANCHES", "BRANCH_ID", ["BRANCH_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'serviceEventTypes' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_SERVICE_EVENT_TYPES", "SERVICE_EVENT_TYPE_ID", ["SERVICE_EVENT_TYPE_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'academicDegree' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_DEGREES", "ACADEMIC_DEGREE_ID", ["ACADEMIC_DEGREE_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'academicUniversity' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_UNIVERSITY", "ACADEMIC_UNIVERSITY_ID", ["ACADEMIC_UNIVERSITY_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'academicProgram' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_PROGRAMS", "ACADEMIC_PROGRAM_ID", ["ACADEMIC_PROGRAM_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'academicCourse' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_COURSES", "ACADEMIC_COURSE_ID", ["ACADEMIC_COURSE_NAME"], ["STATUS" => 'E'],null,null,null,false,true),
                    'rankTypes' => $rankTypes,
                    'profilePictureId' => $profilePictureId
        ]);
    }
