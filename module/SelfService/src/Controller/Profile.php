...
class Profile extends AbstractActionController {
    ...
    public function profileAction() {
        ...
        return Helper::addFlashMessagesToArray($this, [
                    ...
                    'serviceTypes' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_SERVICE_TYPES", "SERVICE_TYPE_ID", ["SERVICE_TYPE_NAME"], ["STATUS" => 'E']),
                    'positions' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_POSITIONS", "POSITION_ID", ["POSITION_NAME"], ["STATUS" => 'E']),
                    'designations' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_DESIGNATIONS", "DESIGNATION_ID", ["DESIGNATION_TITLE"], ["STATUS" => 'E']),
                    'departments' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_DEPARTMENTS", "DEPARTMENT_ID", ["DEPARTMENT_NAME"], ["STATUS" => 'E']),
                    'branches' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_BRANCHES", "BRANCH_ID", ["BRANCH_NAME"], ["STATUS" => 'E']),
                    'serviceEventTypes' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_SERVICE_EVENT_TYPES", "SERVICE_EVENT_TYPE_ID", ["SERVICE_EVENT_TYPE_NAME"], ["STATUS" => 'E']),
                    'academicDegree' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_DEGREES", "ACADEMIC_DEGREE_ID", ["ACADEMIC_DEGREE_NAME"], ["STATUS" => 'E']),
                    'academicUniversity' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_UNIVERSITY", "ACADEMIC_UNIVERSITY_ID", ["ACADEMIC_UNIVERSITY_NAME"], ["STATUS" => 'E']),
                    'academicProgram' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_PROGRAMS", "ACADEMIC_PROGRAM_ID", ["ACADEMIC_PROGRAM_NAME"], ["STATUS" => 'E']),
                    'academicCourse' => ApplicationHelper::getTableKVList($this->adapter, "HRIS_ACADEMIC_COURSES", "ACADEMIC_COURSE_ID", ["ACADEMIC_COURSE_NAME"], ["STATUS" => 'E']),
                    'rankTypes' => $rankTypes,
                    'profilePictureId' => $profilePictureId
        ]);
    }
