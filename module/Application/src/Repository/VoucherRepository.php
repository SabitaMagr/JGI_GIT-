...
class VoucherRepository {
    ...
    public function generateAdvanceVoucher($companyId, $formCode, $transactionDate, $tableName, $branchId, $createdBy, $createdDate, $accCode, $particulars, $amount, $subCode): string {
        try {
            /* Default values
              $companyId='01';
              $formCode='436';
