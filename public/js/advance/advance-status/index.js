(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var columns = [
            ...
            {field: ["ADVANCE_REQUEST_ID"], title: "Action", template: `
            <span>  
            <a class="btn  btn-icon-only btn-success" href="${document.viewLink}/#: ADVANCE_REQUEST_ID #" style="height:17px;" title="view">
