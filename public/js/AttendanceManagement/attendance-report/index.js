...
angular.module('hris', [])
        .controller("allAttendanceReportController", function ($scope, $http) {
            var $tableContainer = $("#allAttendanceReportTable");
            ...
            $scope.view = function () {
                ...
                window.app.serverRequest(document.url, {
                    ...
                    var grid = $('#allAttendanceReportTable').data("kendoGrid");
                    dataSource.read();
            ...
            $scope.initializekendoGrid = function () {
                $("#allAttendanceReportTable").kendoGrid({
                    excel: {
...
//                app.searchTable('allAttendanceReportTable',['FIRST_NAME','REQUESTED_DT','ATTENDANCE_DT','IN_TIME','OUT_TIME','STATUS']);
                ...
                $("#export").click(function (e) {
                    ...
                    var dataSource = $("#allAttendanceReportTable").data("kendoGrid").dataSource;
