(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        app.initializeKendoGrid($tableContainer, columns, null, null, null, 'Appraisal Final Review');
        ...
        $('#excelExport').on('click', function () {
            app.excelExport($tableContainer, map, "Appraisal Final Review List.xlsx");
        });
        $('#pdfExport').on('click', function () {
            app.exportToPDF($tableContainer, map, "Appraisal Final Review List.pdf");
        });
