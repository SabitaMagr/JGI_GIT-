(function ($) {
    ...
    $(document).ready(function () {
        ...
        var columns = [
            ...
            {field: "SUB_EMPLOYEE_NAME", title: "Sub Employee", width: "150px"},
        ...
        var map = {
            ...
            'SUB_EMPLOYEE_NAME': 'Substitute Employe',
            'POSTING_TYPE': 'Posting Type',
        }
        app.initializeKendoGrid($table, columns);

        app.searchTable($table, ['ATTENDANCE_DATE_AD', 'ATTENDANCE_DATE_BS', 'CUSTOMER_ENAME', 'LOCATION_NAME', 'EMPLOYEE_NAME', 'SUB_EMPLOYEE_NAME', 'POSTING_TYPEFF']);
