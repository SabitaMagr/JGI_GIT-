    ...
    $(document).ready(function () {
        ...
        var initKendoGrid = function (defaultColumns, data) {
            ...
            var columns = [
                ...
                {field: "POSITION_NAME", title: "Position", width: 70, locked: true},
                {field: "SERVICE_TYPE_NAME", title: "Service", width: 70, locked: true},
                {field: "MONTH_EDESC", title: "Month", width: 70, locked: true},
                {field: "SALARY_TYPE_NAME", title: "Salary Type", width: 80, locked: true},
                {field: "BANK_NAME", title: "Bank Name", width: 60, locked: true},
                {field: "ACCOUNT_NO", title: "Account No.", width: 70, locked: true}
            ];
