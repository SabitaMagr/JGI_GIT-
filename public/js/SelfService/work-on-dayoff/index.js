(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        ], "Work On day Off List.xlsx");

        app.searchTable('workOnDayoffTbl', ['REQUESTED_DATE_AD', 'REQUESTED_DATE_BS', 'FROM_DATE_AD', 'FROM_DATE_BS', 'TO_DATE_AD', 'TO_DATE_BS', 'DURATION', 'STATUS']);
